...
class MultiHeadAttentionBlock(nn.Module):
    ...
    def __init__(self, d_model: int, h: int, dropout: float) -> None:
        ...
        # ⬇️ Use LoRA for query and value only (common choice)
        self.w_q = LoRALinear(d_model, d_model, r=4, alpha=16)
        self.w_k = nn.Linear(d_model, d_model, bias=False)
        self.w_v = LoRALinear(d_model, d_model, r=4, alpha=16)
